...
2. Toggle **Enable MCP access** (requires instance owner or admin permissions).
   ...
   ![enable-mcp-access.png](/08-0-0-Workflow/_images/advanced-ai/enable-mcp-access.png)
...
4. *Connection details* button that shows detailed instructions for connecting MCP clients
   ...
   ![mcp_page_content.png](/08-0-0-Workflow/_images/advanced-ai/mcp_page_content.png)
...
- **Access Token**
   ...
   ![mcp_connect_menu.png](/08-0-0-Workflow/_images/advanced-ai/mcp_connect_menu.png)
...
3. Use the action menu in each client's row to revoke access for specific clients.
   ...
   ![mcp_revoke_client_access.png](/08-0-0-Workflow/_images/advanced-ai/mcp_revoke_client_access.png)
...
3. Update all connected MCP clients with the new value.
   ...
   ![mcp_rotate_token.png](/08-0-0-Workflow/_images/advanced-ai/mcp_rotate_token.png)
...
2. Option 2: From the workflow editor
	...
	![mcp_workflow_description.png](/08-0-0-Workflow/_images/advanced-ai/mcp_workflow_description.png)
