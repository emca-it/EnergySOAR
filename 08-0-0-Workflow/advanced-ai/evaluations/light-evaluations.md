...
Evaluations use data tables or Google Sheets to store the test dataset. To use Google Sheets as a dataset source, configure a [Google Sheets credential](/08-0-0-Workflow/integrations/builtin/credentials/google/index.md).
```
...
![Example AI workflow ](/08-0-0-Workflow/_images/advanced-ai/evaluations/example-ai-workflow.png)
...
![Sample dataset for a support ticket classification workflow](/08-0-0-Workflow/_images/advanced-ai/evaluations/sample-dataset.png)
...
Each time the [evaluation trigger](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.evaluationtrigger.md) runs, it will output a single item representing one row of your dataset.
...
If you have multiple triggers in your workflow you will need to [merge their branches together](/08-0-0-Workflow/advanced-ai/evaluations/tips-and-common-issues.md#combining-multiple-triggers).

<figure markdown="span">
![Connecting the evaluation trigger](/08-0-0-Workflow/_images/advanced-ai/evaluations/connecting-evaluation-trigger.png)
...
- Insert the 'Set outputs' action of the [evaluation node](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.evaluation.md)
...
<figure markdown="span">
![Connecting the set outputs node](/08-0-0-Workflow/_images/advanced-ai/evaluations/connecting-set-outputs-node.png)
...
![Execute workflow button](/08-0-0-Workflow/_images/advanced-ai/evaluations/execute-workflow-button.png)
...
Once your dataset grows past a handful of examples, consider [metric-based evaluation](/08-0-0-Workflow/advanced-ai/evaluations/metric-based-evaluations.md) to get a numerical view of performance. See also [tips and common issues](/08-0-0-Workflow/advanced-ai/evaluations/tips-and-common-issues.md).
