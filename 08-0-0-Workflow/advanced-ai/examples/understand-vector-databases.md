...
- Document loaders and text splitters: document loaders pull in documents and data, and prepare them for [embedding](/08-0-0-Workflow/glossary.rst#ai-embedding). Document loaders can use text splitters to break documents into chunks.
