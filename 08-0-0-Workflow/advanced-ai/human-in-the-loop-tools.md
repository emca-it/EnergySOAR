...
| Channel | Description |
|---------|-------------|
| [Chat](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-langchain.chat.md) | n8n's built-in chat interface |
| [Slack](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.slack.md) | Send approval requests to a Slack channel or DM |
| [Discord](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.discord/index.md) | Send approval requests to a Discord channel |
| [Telegram](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.telegram/index.md) | Send approval requests through Telegram |
| [Microsoft Teams](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftteams.md) | Send approval requests to a Teams channel or chat |
| [Gmail](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.gmail/index.md) | Send approval requests via email |
| [WhatsApp Business Cloud](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.whatsapp/index.md) | Send approval requests through WhatsApp |
| [Google Chat](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.googlechat.md) | Send approval requests to Google Chat |
| [Microsoft Outlook](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftoutlook.md) | Send approval requests via Outlook email |
...
The [`$fromAI()` function](/08-0-0-Workflow/advanced-ai/examples/using-the-fromai-function.md) works with tools connected to human review steps. This means the AI can dynamically specify tool parameters, and those AI-determined values are what the human reviewer sees and approves.
...
- [AI Agent node](/08-0-0-Workflow/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/index.md)
- [Tools Agent](/08-0-0-Workflow/integrations/builtin/cluster-nodes/root-nodes/n8n-nodes-langchain.agent/tools-agent.md)
- [What is a tool in AI?](/08-0-0-Workflow/advanced-ai/examples/understand-tools.md)
- [Let AI specify tool parameters with $fromAI()](/08-0-0-Workflow/advanced-ai/examples/using-the-fromai-function.md)
