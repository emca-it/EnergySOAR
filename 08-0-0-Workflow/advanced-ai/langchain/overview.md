...
* [Learning resources](/08-0-0-Workflow/advanced-ai/langchain/langchain-learning-resources.md): n8n's documentation for LangChain assumes you're familiar with AI and LangChain concepts. This page provides links to learning resources.
* [LangChain concepts and features in n8n](/08-0-0-Workflow/advanced-ai/langchain/langchain-n8n.md): how n8n represents LangChain concepts and features.
