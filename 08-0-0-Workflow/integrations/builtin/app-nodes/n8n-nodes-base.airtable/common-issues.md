...
Here are some common errors and issues with the [Airtable node](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.airtable/index.md) and steps to resolve or troubleshoot them.
...
Refer to the [Airtable credentials](/08-0-0-Workflow/integrations/builtin/credentials/airtable.md) and [Airtables scopes documentation](https://airtable.com/developers/web/api/scopes) for more information.
