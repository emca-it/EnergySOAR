...
Here are some common errors and issues with the [Discord node](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.discord/index.md) and steps to resolve or troubleshoot them.
...
If you experience issues when working with embeds with the Discord node, you can use the [HTTP Request](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/index.md) with your existing Discord credentials to `POST` to the following URL:
