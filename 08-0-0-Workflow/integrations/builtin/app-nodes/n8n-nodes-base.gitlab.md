...
```{note} Credentials
Refer to [GitLab credentials](/08-0-0-Workflow/integrations/builtin/credentials/gitlab.md) for guidance on setting up authentication. 
```
...
n8n provides a trigger node for GitLab. You can find the trigger node docs [here](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.gitlabtrigger.md).
