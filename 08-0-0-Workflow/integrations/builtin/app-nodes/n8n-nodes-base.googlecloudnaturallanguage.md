...
```{note} Credentials
Refer to [Google Cloud Natural Language credentials](/08-0-0-Workflow/integrations/builtin/credentials/google/index.md) for guidance on setting up authentication. 
```
