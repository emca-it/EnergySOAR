...
```{note} Credentials
Refer to [MQTT credentials](/08-0-0-Workflow/integrations/builtin/credentials/mqtt.md) for guidance on setting up authentication. 
```
...
n8n provides a trigger node for MQTT. You can find the trigger node docs [here](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.mqtttrigger.md).
