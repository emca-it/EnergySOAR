...
```{note} Credentials
Refer to [SecurityScorecard credentials](/08-0-0-Workflow/integrations/builtin/credentials/securityscorecard.md) for guidance on setting up authentication. 
```
