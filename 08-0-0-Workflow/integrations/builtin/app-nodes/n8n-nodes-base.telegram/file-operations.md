...
Use this operation to get a file from Telegram. Refer to [Telegram](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.telegram/index.md) for more information on the Telegram node itself.
