...
n8n provides two nodes for TheHive. Use this node (TheHive) if you want to use TheHive's version 3 or 4 API. If you want to use version 5, use [TheHive 5](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.thehive5.md).
```
```{note} Credentials
Refer to [TheHive credentials](/08-0-0-Workflow/integrations/builtin/credentials/thehive.md) for guidance on setting up authentication. 
```
...
n8n provides a trigger node for TheHive. You can find the trigger node docs [here](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.thehivetrigger.md).
