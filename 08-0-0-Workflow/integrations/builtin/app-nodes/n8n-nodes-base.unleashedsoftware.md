...
```{note} Credentials
Refer to [Unleashed Software credentials](/08-0-0-Workflow/integrations/builtin/credentials/unleashedsoftware.md) for guidance on setting up authentication. 
```
