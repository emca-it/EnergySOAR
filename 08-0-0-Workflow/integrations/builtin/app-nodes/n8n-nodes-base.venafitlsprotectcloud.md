...
```{note} Credentials
Refer to [Venafi TLS Protect Cloud credentials](/08-0-0-Workflow/integrations/builtin/credentials/venafitlsprotectcloud.md) for guidance on setting up authentication. 
```
...
n8n also provides:
<!-- vale off -->
* A [trigger node](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.venafitlsprotectcloudtrigger.md) for Venafi TLS Protect Cloud.
* A [node](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.venafitlsprotectdatacenter.md) for Venafi TLS Protect Datacenter.
<!-- vale on -->
