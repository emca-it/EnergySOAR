...
* **SQLite**: Select this option to use a SQLite database.
    * You must add a [Read/Write File From Disk](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.readwritefile.md) node before the Agent to read your SQLite file.
...
If you are using [Postgres](/08-0-0-Workflow/integrations/builtin/credentials/postgres.md) or [MySQL](/08-0-0-Workflow/integrations/builtin/credentials/mysql.md), this agent doesn't support the credential tunnel options.
```
