...
Unlike the [Code node](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.code/index.md), the LangChain Code node doesn't support Python.
...
By default, you can't load built-in or external modules in this node. Self-hosted users can [enable built-in and external modules](/08-0-0-Workflow/hosting/configuration/configuration-methods.md).
...
![Screenshot of a workflow with four LangChain nodes, configured as different node types](/08-0-0-Workflow/_images/integrations/builtin/cluster-nodes/langchaincode/create-node-types.png)

| Node type | Inputs | Outputs | Code mode |
| --------- | ------ | ------- | --------- |
| App node. Similar to the [Code node](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.code/index.md). | Main | Main | Execute |
...
```{include} ../../../../../_snippets/integrations/builtin/cluster-nodes/langchain-root-nodes/langchaincode/builtin-methods.md
