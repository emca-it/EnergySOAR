...
Use the Default Data Loader node to load binary data files or JSON data for [vector stores](/08-0-0-Workflow/glossary#ai-vector-store) or summarization.
...
* **Text Splitting**: Choose from:
	* **Simple**: Uses the [Recursive Character Text Splitter](/08-0-0-Workflow/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.textsplitterrecursivecharactertextsplitter.md) with a chunk size of 1000 and an overlap of 200.
...
* **Mode**: Choose from:
	...
	* **Load Specific Data**: Use [expressions](/08-0-0-Workflow/code/expressions.md) to define the data you want to load. You can add text as well as expressions. This means you can create a custom document from a mix of text and expressions.
...
```{include} ../../../../../_snippets/integrations/builtin/cluster-nodes/langchain-doc-loaders-link.md
