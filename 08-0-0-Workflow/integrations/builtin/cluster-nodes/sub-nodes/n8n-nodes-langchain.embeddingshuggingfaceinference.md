...
Use the Embeddings HuggingFace Inference node to generate [embeddings](/08-0-0-Workflow/glossary#ai-embedding) for a given text.

On this page, you'll find the node parameters for the Embeddings HuggingFace Inference, and links to more resources.

```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/huggingface.md).
```
