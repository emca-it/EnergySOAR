...
Use the Azure OpenAI Chat Model node to use OpenAI's chat models with conversational [agents](/08-0-0-Workflow/glossary.md#ai-agent).

On this page, you'll find the node parameters for the Azure OpenAI Chat Model node, and links to more resources.

```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/azureopenai.md).
```
...
This node doesn't support the [`NO_PROXY` environment variable](/08-0-0-Workflow/hosting/configuration/environment-variables/deployment.md).
