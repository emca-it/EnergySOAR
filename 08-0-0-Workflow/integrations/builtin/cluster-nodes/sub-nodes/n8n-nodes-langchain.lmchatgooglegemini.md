...
```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/googleai.md).
```
...
If you need to proxy your connection, as a work around, you can set up a dedicated reverse proxy for Gemini requests and change the **Host** parameter in your [Google Gemini credentials](/08-0-0-Workflow/integrations/builtin/credentials/googleai.md) to point to your proxy address:

![Google Gemini credentials proxy configuration](/08-0-0-Workflow/_images/integrations/builtin/cluster-nodes/google-gemini-proxy-config.png)
