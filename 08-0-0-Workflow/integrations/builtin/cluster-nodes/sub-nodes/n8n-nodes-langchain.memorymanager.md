...
The Chat Memory Manager node manages chat message [memories](/08-0-0-Workflow/glossary.md#ai-memory) within your workflows. Use this node to load, insert, and delete chat messages in an in-memory [vector store](/08-0-0-Workflow/glossary.md#ai-vector-store).

```{include} ../../../../../_snippets/integrations/builtin/cluster-nodes/langchain-sub-nodes/chat-memory-manager-purpose.md
