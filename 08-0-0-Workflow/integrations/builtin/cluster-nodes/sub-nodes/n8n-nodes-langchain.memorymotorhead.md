...
Use the Motorhead node to use Motorhead as a [memory](/08-0-0-Workflow/glossary.md#ai-memory) server.

On this page, you'll find a list of operations the Motorhead node supports, and links to more resources.

```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/motorhead.md).
```
