...
The Reranker Cohere node allows you to [rerank](/08-0-0-Workflow/glossary.md#ai-reranking) the resulting chunks from a [vector store](/08-0-0-Workflow/glossary.md#ai-vector-store). You can connect this node to a vector store.
