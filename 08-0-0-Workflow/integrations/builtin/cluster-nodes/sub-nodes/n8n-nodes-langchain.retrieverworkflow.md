...
* **Parameter** and copy in a complete [workflow JSON](/08-0-0-Workflow/workflows/export-import.md).

### Workflow values

```{include} ../../../../../_snippets/integrations/builtin/cluster-nodes/langchain-sub-nodes/workflow-values.md
