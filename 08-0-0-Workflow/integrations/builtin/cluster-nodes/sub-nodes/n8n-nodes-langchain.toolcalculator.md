...
The Calculator node is a [tool](/08-0-0-Workflow/glossary.md#ai-tool) that allows an [agent](/08-0-0-Workflow/glossary.md#ai-agent) to run mathematical calculations.
