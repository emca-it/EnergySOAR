...
New instances of the HTTP Request tool node that you add to workflows use the standard [HTTP Request](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/index.md) node as a tool. This page is describes the legacy, standalone HTTP Request tool node.
...
The HTTP Request tool works just like the [HTTP Request](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/index.md) node, but it's designed to be used with an [AI agent](/08-0-0-Workflow/glossary.md#ai-agent) as a tool to collect information from a website or API.
