...
```{note} Credentials
The MCP Client Tool node supports [Bearer](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-bearer-auth), generic [header](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-header-auth), and [OAuth2](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-oauth2) authentication methods.
```
...
* **Authentication**: The authentication method for authentication to your MCP server. The MCP tool supports [bearer](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-bearer-auth), generic [header](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-header-auth), and [OAuth2](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-oauth2) authentication. Select **None** to attempt to connect without authentication.
