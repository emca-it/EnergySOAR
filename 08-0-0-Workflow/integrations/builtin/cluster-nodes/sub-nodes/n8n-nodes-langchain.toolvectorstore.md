...
The Vector Store Question Answer node is a [tool](/08-0-0-Workflow/glossary.md#ai-tool) that allows an [agent](/08-0-0-Workflow/glossary.md#ai-agent) to summarize results and answer questions based on chunks from a [vector store](/08-0-0-Workflow/glossary.md#ai-vector-store). 
...
![model errors from special characters](/08-0-0-Workflow/_images/integrations/builtin/cluster-nodes/toolvectorstore/name-characters-error.png)
