...
```{include} ../../../../_snippets/integrations/builtin/core-nodes/schedule/timezone-settings.md

```

```{note} Date and time in other nodes
You can work with data and time in the Code node, and in expressions in any node. n8n supports Luxon to help work with date and time in JavaScript. Refer to [Date and time with Luxon](/08-0-0-Workflow/code/cookbook/luxon.md) for more information.
```
...
The Date & Time node uses [Luxon](https://moment.github.io/luxon). You can also use Luxon in the [Code](/08-0-0-Workflow/code/code-node.md) node and [expressions](/08-0-0-Workflow/code/expressions.md). Refer to [Date and time with Luxon](/08-0-0-Workflow/code/cookbook/luxon.md) for more information.
