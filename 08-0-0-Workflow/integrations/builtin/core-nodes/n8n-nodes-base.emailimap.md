...
```{note} Credential
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/imap/index.md).
```
...
Select or create an [IMAP credential](/08-0-0-Workflow/integrations/builtin/credentials/imap/index.md) to connect to the server with.
