...
```{include} ../../../../_snippets/flow-logic/create-set-error-workflow.md
...
You can use the [Stop And Error](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.stopanderror.md) node to send custom messages to the Error Trigger.

Read more about [Error workflows](/08-0-0-Workflow/flow-logic/error-handling.md) in n8n workflows. 

## Error data

```{include} ../../../../_snippets/integrations/builtin/core-nodes/error-trigger/error-data.md
