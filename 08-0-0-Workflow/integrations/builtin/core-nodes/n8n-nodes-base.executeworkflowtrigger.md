...
This node runs in response to a call from the [Execute Sub-workflow](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow.md) or [Call n8n Workflow Tool](/08-0-0-Workflow/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.toolworkflow.md) nodes.

```{include} ../../../../_snippets/flow-logic/subworkflow-usage.md
...
```{include} ../../../../_snippets/flow-logic/subworkflow-data-flow.md
