...
You can retrieve custom execution data during workflow execution using the Code node. Refer to [Custom executions data](/08-0-0-Workflow/workflows/executions/custom-executions-data.md) for more information.

```{include} ../../../../_snippets/workflows/executions/custom-execution-data-availability.md
