...
You can add more pages to continue the form with the [n8n Form](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.form.md) node.
...
![Screenshot of the form URLs](/08-0-0-Workflow/_images/integrations/builtin/core-nodes/form-trigger/form-urls.png)
...
- **Element Type**: Choose from **Checkboxes**, **Custom HTML**, **Date**, **Dropdown**, **Email**, **File**, **Hidden Field**, **Number**, **Password**, **Radio Buttons**, **Text**, or **Textarea**.
    ...
    - Select **Date** to include a date picker in the form. Refer to [Date and time with Luxon](/08-0-0-Workflow/code/cookbook/luxon.md) for more information on formatting dates.
...
- **Use Workflow Timezone**: Turn on to use the timezone in the [Workflow settings](/08-0-0-Workflow/workflows/settings.md) instead of UTC (default). This affects the value of the `submittedAt` timestamp in the node output. 
