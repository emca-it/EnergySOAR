...
You can use [Expressions](/08-0-0-Workflow/code/expressions.md) in the template, including n8n's [Built-in methods and variables](/08-0-0-Workflow/code/builtin/overview.md). 
