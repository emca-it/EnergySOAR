...
Refer to [Splitting with conditionals](/08-0-0-Workflow/flow-logic/splitting.md) for more information on using conditionals to create complex logic in n8n.

If you need more than two conditional outputs, use the [Switch node](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.switch.md).

```{include} ../../../../_snippets/integrations/builtin/core-nodes/data-types.md
