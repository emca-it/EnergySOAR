...
```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/jwt.md).
```
...
* **Credential to connect with**: Select or create a [JWT credential](/08-0-0-Workflow/integrations/builtin/credentials/jwt.md) to connect with.
