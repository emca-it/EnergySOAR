...
```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/ldap.md).
```
...
* **Credential to connect with**: Select or create an [LDAP credential](/08-0-0-Workflow/integrations/builtin/credentials/ldap.md) to connect with.
