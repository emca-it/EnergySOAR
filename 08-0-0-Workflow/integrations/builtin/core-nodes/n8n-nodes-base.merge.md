...
![Sample Append mode inputs and output. Two separate data sources are on the left, one with items A, B, C and one with items D, E, F. The final data source combines both and lists A, B, C, D, E, F.](/08-0-0-Workflow/_images/integrations/builtin/core-nodes/merge/append-diagram.png)
...
<figure markdown="span">
![Sample Combine mode inputs and output. Two separate data sources are on the left. The final data source combines these data sources by matching fields.](/08-0-0-Workflow/_images/integrations/builtin/core-nodes/merge/merge-by-field-diagram.png)
...
<figure markdown="span">
![Sample Combine mode inputs and output. Two separate data sources are on the left. The final data source combines these data sources by index position.](/08-0-0-Workflow/_images/integrations/builtin/core-nodes/merge/merge-by-position-diagram.png)
...
<figure markdown="span">
![Sample Combine mode inputs and output. Two separate data sources are on the left. The final data source combines these data sources by all possible combinations.](/08-0-0-Workflow/_images/integrations/builtin/core-nodes/merge/multiplex-diagram.png)
...
```{include} ../../../../_snippets/integrations/builtin/core-nodes/merge/field-value-clash.md
...
```{include} ../../../../_snippets/integrations/builtin/core-nodes/merge/if-merge-branch-execution.md
