...
Here are some templates and examples for the [Remove Duplicates node](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.removeduplicates/index.md).
...
<!-- Templates widget commented out
