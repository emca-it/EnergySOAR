...
```{note} Credential
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/sendemail/index.md).
```
...
Select or create an [SMTP account credential](/08-0-0-Workflow/integrations/builtin/credentials/sendemail/index.md) for the node to use.
...
* Use the [Read/Write Files from Disk](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.readwritefile.md) node or the [HTTP Request](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/index.md) node to upload the file to your workflow.
