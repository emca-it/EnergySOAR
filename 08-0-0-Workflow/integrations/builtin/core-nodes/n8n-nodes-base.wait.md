...
```{note} Auth reference
Refer to the [Webhook node | Authentication documentation](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.webhook/index.md#supported-authentication-methods) for more information on each auth type.
```

#### HTTP Method

Select the HTTP method the webhook should use. Refer to the [Webhook node | HTTP Method documentation](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.webhook/index.md#http-method) for more information.
...
* **Using 'Respond to Webhook' Node**: Respond as defined in the [Respond to Webhook](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.respondtowebhook.md) node.
...
* **Using 'Respond to Webhook' Node**: Respond when the [Respond to Webhook](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.respondtowebhook.md) node executes.
