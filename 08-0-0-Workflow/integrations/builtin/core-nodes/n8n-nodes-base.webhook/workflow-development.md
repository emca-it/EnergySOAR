...
The [Webhook node](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.webhook/index.md) works a bit differently from other core nodes. n8n recommends following these processes for building, testing, and using your Webhook node in production.
...
When using the Webhook node on localhost on a [self-hosted](/08-0-0-Workflow/hosting/index.md) n8n instance, run n8n in tunnel mode:

* [npm with tunnel](/08-0-0-Workflow/hosting/installation/npm.md#n8n-with-tunnel)
* [Docker with tunnel](/08-0-0-Workflow/hosting/installation/docker.md#n8n-with-tunnel)
...
Refer to [Create a workflow](/08-0-0-Workflow/workflows/create.md) for more information on publishing workflows.
