...
```{warning} Deprecated
n8n has deprecated the Workflow Trigger node and moved its functionality to the [n8n Trigger node](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.n8ntrigger.md).
```
