...
```{note} Binary files
If your XML is within a binary file, use the [Extract from File](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.extractfromfile.md) node to convert it to text first.
```
