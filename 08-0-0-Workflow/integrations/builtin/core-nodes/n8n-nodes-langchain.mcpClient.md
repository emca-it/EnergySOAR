...
If you want to use MCP tools as tools for an AI Agent, use the [MCP Client Tool node](/08-0-0-Workflow/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.toolmcp.md) instead.

```{note} Credentials
The MCP Client node supports [Bearer](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-bearer-auth), generic [header](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-header-auth), and [OAuth2](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-oauth2) authentication methods.
```
...
* **Authentication**: The authentication method for authentication to your MCP server. The MCP Client node supports [bearer](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-bearer-auth), generic [header](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-header-auth), and [OAuth2](/08-0-0-Workflow/integrations/builtin/credentials/httprequest.md#using-oauth2) authentication. Select **None** to attempt to connect without authentication.
...
To use MCP tools with AI Agents, n8n has the [MCP Client Tool node](/08-0-0-Workflow/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.toolmcp.md).

n8n also has an [MCP Server Trigger](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-langchain.mcptrigger.md) node that allows you to expose n8n tools to external AI Agents.
...
```{include} ../../../../_snippets/integrations/builtin/cluster-nodes/tools-link.md
