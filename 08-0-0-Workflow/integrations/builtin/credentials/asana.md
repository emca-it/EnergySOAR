...
- [Asana Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.asanatrigger.md)
...
If you're [self-hosting](/08-0-0-Workflow/hosting/index.md) n8n, you'll need to register an application to set up OAuth:
