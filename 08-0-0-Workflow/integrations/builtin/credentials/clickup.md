...
- [ClickUp Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.clickuptrigger.md)
...
If you're [self-hosting](/08-0-0-Workflow/hosting/index.md) n8n, you'll need to create an OAuth app:
