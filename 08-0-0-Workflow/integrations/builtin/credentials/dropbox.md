...
4. In **Choose the type of access you need**, choose whichever option best fits your use of the [Dropbox](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.dropbox.md) node:
...
If you're [self-hosting](/08-0-0-Workflow/hosting/index.md) n8n, you'll need to configure OAuth2 manually:
