...
- [Facebook Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.facebooktrigger/index.md)

```{note} Facebook Graph API credentials
If you want to create credentials for the [Facebook Graph API](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.facebookgraphapi.md) node, follow the instructions in the [Facebook Graph API credentials](/08-0-0-Workflow/integrations/builtin/credentials/facebookgraph.md) documentation.
```
...
Refer to the [Facebook Trigger node](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.facebooktrigger/index.md) documentation for more information.
