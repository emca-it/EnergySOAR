...
If you want to create credentials for the [Facebook Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.facebooktrigger/index.md) node, follow the instructions mentioned in the [Facebook App credentials](/08-0-0-Workflow/integrations/builtin/credentials/facebookapp.md) documentation.
```
