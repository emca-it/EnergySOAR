...
- [GitLab Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.gitlabtrigger.md)
...
If you're [self-hosting](/08-0-0-Workflow/hosting/index.md) n8n, you'll need a [GitLab](https://gitlab.com/) account. Then create a new GitLab application:
