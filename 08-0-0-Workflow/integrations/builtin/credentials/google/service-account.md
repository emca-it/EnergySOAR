...
* Check if your node is [compatible](/08-0-0-Workflow/integrations/builtin/credentials/google/index.md#compatible-nodes) with Service Account.
* Make sure you need to use Service Account. For most use cases, [OAuth2](/08-0-0-Workflow/integrations/builtin/credentials/google/oauth-single-service.md) is a better option.
...
```{include} ../../../../../_snippets/integrations/builtin/credentials/google/create-google-cloud-project.md
```
...
```{include} ../../../../../_snippets/integrations/builtin/credentials/google/enable-apis.md
```
...
1. Access your [Google Cloud Console - Library](https://console.cloud.google.com/apis/library). Make sure you're in the correct project.
	...
	![The project dropdown in the Google Cloud top navigation](/08-0-0-Workflow/_images/integrations/builtin/credentials/google/google-cloud-project-dropdown.png)
...
5. If you plan to use this credential with the [HTTP Request](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.httprequest/index.md) node, turn on **Set up for use in HTTP Request node**.
