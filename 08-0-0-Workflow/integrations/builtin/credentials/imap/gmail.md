...
```{include} ../../../../../_snippets/integrations/builtin/credentials/email/gmail-two-step-verification.md
```

### Generate an app password

```{include} ../../../../../_snippets/integrations/builtin/credentials/email/gmail-app-password.md
```
