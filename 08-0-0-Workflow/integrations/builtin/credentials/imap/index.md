...
- [IMAP Email](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.emailimap.md)
...
Refer to [Gmail](/08-0-0-Workflow/integrations/builtin/credentials/imap/gmail.md).

#### Outlook.com

Refer to [Outlook.com](/08-0-0-Workflow/integrations/builtin/credentials/imap/outlook.md).

#### Yahoo

Refer to [Yahoo](/08-0-0-Workflow/integrations/builtin/credentials/imap/yahoo.md).
