...
* [Linear Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.lineartrigger.md)
* [Linear](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.linear.md)
...
- To use this credential with the [Linear Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.lineartrigger.md) node, you must enable the **Include Admin Scope** toggle.
