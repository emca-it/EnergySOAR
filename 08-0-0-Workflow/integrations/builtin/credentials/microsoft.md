...
- [Microsoft Dynamics CRM](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftdynamicscrm.md)
- [Microsoft Excel](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftexcel.md)
- [Microsoft Graph Security](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftgraphsecurity.md)
...
- [Microsoft SharePoint](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftsharepoint.md)
- [Microsoft Teams](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftteams.md)
- [Microsoft Teams Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.microsoftteamstrigger.md)
...
```{include} ../../../../_snippets/integrations/builtin/credentials/microsoft-need-admin-approval.md
```
