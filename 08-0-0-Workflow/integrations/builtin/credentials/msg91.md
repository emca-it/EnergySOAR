...
- [MSG91](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.msg91.md)
...
For the n8n credentials to function with this setting enabled, add all the [n8n IP addresses](/08-0-0-Workflow/manage-cloud/cloud-ip.md) as whitelisted IPs in MSG91. You can add them in one of two places, depending on your desired security level:
