...
- [Pipedrive Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.pipedrivetrigger.md)
...
Scopes you may need for the [Pipedrive](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.pipedrive.md) node:
...
The [Pipedrive Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.pipedrivetrigger.md) node requires the **Webhooks: Full access** (`webhooks:full`) scope.
