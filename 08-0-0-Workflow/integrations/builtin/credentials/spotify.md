...
If you're [self-hosting](/08-0-0-Workflow/hosting/index.md) n8n, you'll need a [Spotify Developer](https://developer.spotify.com/) account so you can create a Spotify app:
