...
- [TheHive](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.thehive.md)

```{note} TheHive and TheHive 5
n8n provides two nodes for TheHive. Use these credentials with TheHive node for TheHive 3 or TheHive 4. If you're using TheHive5 node, use [TheHive 5 credentials](/08-0-0-Workflow/integrations/builtin/credentials/thehive5.md).
```
...
- An **API Version**: Choose between:
    - **TheHive 3 (api v0)**
    - **TheHive 4 (api v1)**
    - For TheHive 5, use [TheHive 5 credentials](/08-0-0-Workflow/integrations/builtin/credentials/thehive5.md) instead.
