...
- [TheHive 5](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.thehive5.md)

```{note} TheHive and TheHive 5
n8n provides two nodes for TheHive. Use these credentials with TheHive 5 node. If you're using TheHive node for TheHive 3 or TheHive 4, use [TheHive credentials](/08-0-0-Workflow/integrations/builtin/credentials/thehive.md).
```
