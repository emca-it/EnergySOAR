...
- [WhatsApp Business Cloud](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.whatsapp/index.md)
- [WhatsApp Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.whatsapptrigger.md)
...
- API key: Use for the [WhatsApp Business Cloud](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.whatsapp/index.md) node.
- OAuth2: Use for the [WhatsApp Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.whatsapptrigger.md) node.
...
You need WhatsApp API key credentials to use the [WhatsApp Business Cloud](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.whatsapp/index.md) node.
...
You need WhatsApp OAuth2 credentials to use the [WhatsApp Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.whatsapptrigger.md) node.
