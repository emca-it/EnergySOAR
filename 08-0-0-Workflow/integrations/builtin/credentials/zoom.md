...
- Enter **Scopes** for the scopes you plan to use. For all functionality in the [Zoom](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.zoom.md) node, select:
    - `meeting:read`
    - `meeting:write`
