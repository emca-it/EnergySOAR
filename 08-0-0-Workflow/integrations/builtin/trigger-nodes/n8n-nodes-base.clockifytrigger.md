...
```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/clockify.md).
```
...
This node uses the workflow timezone setting to specify the range of time entries starting time. Configure the timezone in your [Workflow Settings](/08-0-0-Workflow/workflows/settings.md) if you want this trigger node to retrieve the right time entries.
