...
```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/convertkit.md).
```
...
n8n provides an app node for ConvertKit. You can find the node docs [here](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.convertkit.md).
