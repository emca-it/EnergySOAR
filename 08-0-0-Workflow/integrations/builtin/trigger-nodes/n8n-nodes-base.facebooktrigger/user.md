...
Use this object to receive updates when changes to a user's profile occur. Refer to [Facebook Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.facebooktrigger/index.md) for more information on the trigger itself.
