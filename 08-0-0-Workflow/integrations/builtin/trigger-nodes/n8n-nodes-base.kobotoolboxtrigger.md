...
```{note} Credentials
You can find authentication information for this node [here](/08-0-0-Workflow/integrations/builtin/credentials/kobotoolbox.md).
```
...
It works the same way as the Get Submission operation in the [KoboToolbox](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.kobotoolbox.md) node, including supporting the same reformatting options.
