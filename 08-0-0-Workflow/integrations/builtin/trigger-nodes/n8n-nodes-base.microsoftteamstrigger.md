...
n8n provides an app node for Microsoft Teams. You can find the node docs [here](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.microsoftteams.md).
