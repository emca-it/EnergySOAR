...
n8n provides two nodes for TheHive. Use this node (TheHive 5 Trigger) if you want to use TheHive's version 5 API. If you want to use version 3 or 4, use [TheHive Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.thehivetrigger.md).
```
...
n8n provides an app node for TheHive 5. You can find the node docs [here](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.thehive5.md).
