...
n8n provides two nodes for TheHive. Use this node (TheHive Trigger) if you want to use TheHive's version 3 or 4 API. If you want to use version 5, use [TheHive 5 Trigger](/08-0-0-Workflow/integrations/builtin/trigger-nodes/n8n-nodes-base.thehive5trigger.md).
```
...
n8n provides an app node for TheHive. You can find the node docs [here](/08-0-0-Workflow/integrations/builtin/app-nodes/n8n-nodes-base.thehive.md).
