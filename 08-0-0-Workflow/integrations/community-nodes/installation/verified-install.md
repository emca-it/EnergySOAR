...
To install a [verified community node](/08-0-0-Workflow/integrations/creating-nodes/deploy/submit-community-nodes.md#submit-your-node-for-verification-by-n8n):
...
Some users may not want to show verified community nodes in the nodes panel of their instances. On n8n cloud, instance owners can toggle this in the [Cloud Admin Panel](/08-0-0-Workflow/manage-cloud/cloud-admin-dashboard.md). Self-hosted users can use [environment variables](/08-0-0-Workflow/hosting/configuration/environment-variables/nodes.md) to control the availability of this feature.
```
...
2. On the node you want to install, select **Options** <span class="n8n-inline-image">![Three dots options menu](/08-0-0-Workflow/_images/common-icons/three-dot-options-menu.png){.off-glb}</span>.
