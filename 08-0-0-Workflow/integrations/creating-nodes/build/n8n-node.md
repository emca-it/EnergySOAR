...
Using `n8n-node`, you can create nodes that adhere to the [guidelines for verified community nodes](/08-0-0-Workflow/integrations/creating-nodes/build/reference/verification-guidelines.md).
...
* **What kind of node are you building?** The [node type](/08-0-0-Workflow/integrations/creating-nodes/plan/choose-node-method.md) you want to build:
...
![node in nodes panel](/08-0-0-Workflow/_images/integrations/creating-nodes/n8n-node/node_in_nodes_panel.png)
