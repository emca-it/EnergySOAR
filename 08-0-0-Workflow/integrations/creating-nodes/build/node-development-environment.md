...
* A local instance of n8n. You can install n8n with `npm install n8n -g`, then follow the steps in [Run your node locally](/08-0-0-Workflow/integrations/creating-nodes/test/run-node-locally.md) to test your node.
* When [building verified community nodes](/08-0-0-Workflow/integrations/community-nodes/build-community-nodes.md), you must use the [`n8n-node` tool](/08-0-0-Workflow/integrations/creating-nodes/build/n8n-node.md) to create and test your node.
