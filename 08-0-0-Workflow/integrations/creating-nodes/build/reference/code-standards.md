...
Following defined code standards when building your node makes your code more readable and maintainable, and helps avoid errors. This document provides guidance on good code practices for node building. It focuses on code details. For UI standards and UX guidance, refer to [Node UI design](/08-0-0-Workflow/integrations/creating-nodes/plan/node-ui-design.md).

## Use the linter

The n8n node linter provides automatic checking for many of the node-building standards. You should ensure your node passes the linter's checks before publishing it. Refer to the [n8n node linter](/08-0-0-Workflow/integrations/creating-nodes/test/node-linter.md) documentation for more information.
...
Refer to [HTTP helpers](/08-0-0-Workflow/integrations/creating-nodes/build/reference/http-helpers.md) for more information, and for migration instructions for the removed `this.helpers.request`.
