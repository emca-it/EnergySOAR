...
![String](/08-0-0-Workflow/_images/integrations/creating-nodes/string.png)
...
![Password](/08-0-0-Workflow/_images/integrations/creating-nodes/password.png)
...
![Multiple rows](/08-0-0-Workflow/_images/integrations/creating-nodes/multiple-rows.png)

### Support drag and drop for data keys

Users can drag and drop data values to map them to fields. Dragging and dropping creates an [expression](/08-0-0-Workflow/glossary.md#expression-n8n) to load the data value. n8n supports this automatically.
...
![Decimal](/08-0-0-Workflow/_images/integrations/creating-nodes/decimal.png)
...
![Collection](/08-0-0-Workflow/_images/integrations/creating-nodes/collection.png)
...
![DateTime](/08-0-0-Workflow/_images/integrations/creating-nodes/datetime.png)
...
![Boolean](/08-0-0-Workflow/_images/integrations/creating-nodes/boolean.png)
...
![Color](/08-0-0-Workflow/_images/integrations/creating-nodes/color.png)
...
![Options](/08-0-0-Workflow/_images/integrations/creating-nodes/options.png)
...
![Multi-options](/08-0-0-Workflow/_images/integrations/creating-nodes/multioptions.png)
...
![Filter](/08-0-0-Workflow/_images/integrations/creating-nodes/filter.png)
...
![A gif showing the drag and drop action, as well as changing a field to fixed](/08-0-0-Workflow/_images/integrations/builtin/core-nodes/set/drag-drop-fixed-toggle.gif)
...
![Fixed collection](/08-0-0-Workflow/_images/integrations/creating-nodes/fixed-collection.png)



## Resource locator

![Resource locator](/08-0-0-Workflow/_images/integrations/creating-nodes/resource-locator.png)
...
![JSON](/08-0-0-Workflow/_images/integrations/creating-nodes/json.png)
...
Display a yellow box with a hint or extra info. Refer to [Node UI design](/08-0-0-Workflow/integrations/creating-nodes/plan/node-ui-design.md) for guidance on writing good hints and info text.
...
```
![Notice](/08-0-0-Workflow/_images/integrations/creating-nodes/notice.png)
