...
All verified community node authors should use the [`n8n-node` tool](/08-0-0-Workflow/integrations/creating-nodes/build/n8n-node.md) to create and check their package. This helps n8n ensure quality and consistency by:
...
* Use **TypeScript** and follow n8n's [**node development guidelines**](/08-0-0-Workflow/integrations/creating-nodes/overview.md).
