...
This applies to programmatic nodes (including trigger nodes). You don't need to consider item linking when building a declarative-style node. Refer to [Choose your node building approach](/08-0-0-Workflow/integrations/creating-nodes/plan/choose-node-method.md) for more information on node styles.
