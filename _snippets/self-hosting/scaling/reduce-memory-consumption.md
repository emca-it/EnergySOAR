...
Splitting the workflow might seem counter-intuitive at first as it usually requires adding at least two more nodes: the [Loop Over Items](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.splitinbatches.md) node to split up the items into smaller batches and the [Execute Workflow](/08-0-0-Workflow/integrations/builtin/core-nodes/n8n-nodes-base.executeworkflow.md) node to start the sub-workflow.
